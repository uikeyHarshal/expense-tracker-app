  ...
  if (active && payload && payload.length) {
    return (
      <div className="bg-white dark:bg-[#1A1E24] p-3.5 rounded-xl shadow-xl border border-[#E2E8F0] dark:border-[#2C323A] text-xs">
        <p className="font-bold text-[#0F1115] dark:text-[#F4F1EA] mb-2 border-b border-[#E2E8F0] dark:border-[#2C323A] pb-1">
          {label}
        </p>
          ...
          <AreaChart data={formattedData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
            <defs>
              <linearGradient id="incomeGradient" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor="#45B97C" stopOpacity={0.3} />
                <stop offset="95%" stopColor="#45B97C" stopOpacity={0.0} />
              </linearGradient>
              <linearGradient id="expenseGradient" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor="#D95C68" stopOpacity={0.3} />
                <stop offset="95%" stopColor="#D95C68" stopOpacity={0.0} />
              </linearGradient>
            </defs>
